<script lang="ts">
	...
	const heroSectionContentModel = new TanoshiContainerModel('c')
		.setDesktopSpacing('centered')
		.setItemsAlignment('center');
	const heroHeaderModel = new TanoshiHeaderModel('Dramatically Engage')
		.setDisplaySize('6xl')
		.setHtmlSize('h1')
		.setAligment('center');
	const heroParagraphModel = new TanoshiParagraphModel(
	...
	const collaborationSectionAlignementModel = new TanoshiContainerModel('c')
		.setDesktopSpacing('centered')
		.setItemsAlignment('center');
	const collaborationSectionContentModel = new TanoshiContainerModel('c')
		.setDesktopSpacing('centered')
		.setItemsAlignment('center')
		.setSize('sm:w-8/12');
	const collaborationSectionHeaderModel = new TanoshiContainerModel('r')
		.setDesktopSpacing('centered')
		.setItemsAlignment('end');
	...
	const collaborationHeaderModel = new TanoshiHeaderModel('Superior Collaboration')
		.setDisplaySize('3xl')
		.setHtmlSize('h2');
	const collaborationSubHeaderModel = new TanoshiHeaderModel('Visualize Quality')
		.setDisplaySize('2xl')
		.setHtmlSize('h2');
	const collaborationParagraphModel = new TanoshiParagraphModel(
	...
	const roundImageModel = new TanoshiImageModel(roundImageSource, 'round image').setTheme(
		'circled'
	);

	const orangeSectionContentModel = new TanoshiContainerModel('c')
		.setDesktopSpacing('centered')
		.setItemsAlignment('center')
		.setTheme('warning');

	const cardHeaderModel = new TanoshiHeaderModel('Efficiently unleash')
		.setDisplaySize('xl')
		.setHtmlSize('h3');
