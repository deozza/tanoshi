<script lang="ts">
    ...
    const radioChoice1Input: TanoshiChoiceInputModel = new TanoshiChoiceInputModel('radio 1').setReadonly(true)
    const radioChoice2Input: TanoshiChoiceInputModel = new TanoshiChoiceInputModel('radio 2').setReadonly(true)
    const radioChoice3Input: TanoshiChoiceInputModel = new TanoshiChoiceInputModel('radio 3').setReadonly(true)
    ...
    const checkboxChoice1Input: TanoshiChoiceInputModel = new TanoshiChoiceInputModel('checkbox 1').setType(INPUT_CHOICES_TYPES.Checkbox).setReadonly(true)
    const checkboxChoice2Input: TanoshiChoiceInputModel = new TanoshiChoiceInputModel('checkbox 2').setType(INPUT_CHOICES_TYPES.Checkbox).setReadonly(true)
    const checkboxChoice3Input: TanoshiChoiceInputModel = new TanoshiChoiceInputModel('checkbox 3').setType(INPUT_CHOICES_TYPES.Checkbox).setReadonly(true)
...
<Hst.Story title="molecules/label and input/readonly" layout={{ type: 'grid', width: 600 }}>
