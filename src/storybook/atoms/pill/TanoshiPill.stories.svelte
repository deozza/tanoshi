<script lang="ts">
	...
	const outlinedSecondaryPill = new TanoshiPillModel('Secondary')
		.setTheme('secondary')
		.setIsOutlined(true);
	const outlinedInfoPill = new TanoshiPillModel('Info').setTheme('info').setIsOutlined(true);
	const outlinedSuccessPill = new TanoshiPillModel('Success')
		.setTheme('success')
		.setIsOutlined(true);
	const outlinedWarningPill = new TanoshiPillModel('Warning')
		.setTheme('warning')
		.setIsOutlined(true);
